      ...
      <section id="menu" className="py-24 border-t border-stone-200 dark:border-zinc-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between mb-16 text-center md:text-left gap-6">
            ...
            <a href="/recipes" className="flex-shrink-0 flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-full font-bold transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
              View All Balinese Recipes
            </a>
          </div>
        </div>
          ...
          <div>
            <div className="max-w-7xl mx-auto px-6 mb-6">
              <h3 className="text-2xl font-black text-green-700 dark:text-green-500 tracking-tight flex items-center gap-3">
                ...
                Regular Menu
                <span className="text-sm font-normal text-stone-600 ml-2">← Scroll →</span>
              </h3>
            </div>
