...
export default function PickupSchedule() {
  const schedule = [
    { area: 'Nusa Dua', morning: '06:00 am – 06:30 am', afternoon: '13:00 pm – 13:30 pm' },
    { area: 'Kuta', morning: '06:30 am – 07:30 am', afternoon: '13:30 pm – 14:00 pm' },
    { area: 'Sanur', morning: '07:00 am – 07:30 am', afternoon: '14:00 pm – 14:30 pm' },
    { area: 'Ubud', morning: '08:00 am – 08:30 am', afternoon: '14:00 pm – 14:30 pm' },
  ]
  ...
  return (
    <section className="py-24 px-6 max-w-5xl mx-auto border-t border-stone-200 dark:border-zinc-800">
      <div className="flex flex-col items-center mb-16 text-center">
        ...
        <p className="text-stone-500 dark:text-stone-400 max-w-2xl text-lg font-light">We offer two classes everyday. <strong className="font-bold text-stone-900 dark:text-white">Free shuttle service</strong> is available for the Ubud area.</p>
      </div>
