      ...
      <section className="py-12 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col items-center bg-white dark:bg-zinc-900 p-8 md:p-10 rounded-3xl border border-stone-200 dark:border-zinc-800 shadow-sm hover:shadow-md transition-shadow gap-6">
           ...
           <div className="flex flex-wrap justify-center gap-6 mt-2 pt-8 border-t border-stone-100 dark:border-zinc-800 w-full">
             <a href="https://www.getyourguide.com/-s775245" target="_blank" rel="noreferrer" className="hover:opacity-90 transition-opacity">
             ...
             <a href="https://www.getyourguide.com/ubud-l32246/ubud-balinese-cooking-class-with-rice-terrace-walk-t1384252/" target="_blank" rel="noreferrer" className="hover:opacity-90 transition-opacity">
